...
class Trajet {
    ...
    //input : trajet id
    //returns array of objects from class Utilisateur
    public static function findPassagers($id) {
        $sql = "SELECT u.login, u.nom, u.prenom FROM Utilisateur u INNER JOIN Passager p ON p.utilisateur_login = u.login AND p.trajet_id = :id;";
